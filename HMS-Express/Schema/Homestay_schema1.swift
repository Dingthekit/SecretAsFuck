...
internal class Homestay_schema1: NSObject, NSCopying{
    ...
    // Ctor
    init(CID : String ,name: String, address1: String, address2: String, postalcode: String, city: String, state: String, typeofhomestay: String) {
        self.CID = CID
        self.name = name
    ...
    convenience override init() {
        self.init(CID: "" ,name: "", address1: "", address2: "", postalcode:  "",  city : "" , state : "", typeofhomestay: "")
    }
    ...
    public func copy(with zone: NSZone? = nil) -> Any {
        let copy = Homestay_schema1( CID : CID, name: name, address1: address1, address2:  address2, postalcode: postalcode, city: city, state: state , typeofhomestay: typeofhomestay)
        return copy
    }
